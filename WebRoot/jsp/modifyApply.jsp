				...
				<legend>${actionname }信息</legend>
				  <table style="width:95%"  class="table table-striped table-hover table-bordered">
				  	<tr>
					    ...
					    <td width="84%">
					    	<select name="userId" id="Apply_user">
				    ...
				    <tr>
					    <td nowrap align="right" width="15%">申请日期:</td>
					    <td width="84%">
				  	...
				  	<tr>
					    <td align="right" width="15%">申请理由:</td>
					    <td width="84%">
					    	<input name="reason" value="${modifybean.reason}" class="required" type="text" size="80"/>
					    </td>
				    </tr>
				  	...
				  	<tr>
					    ...
					    <td width="84%">
					    	<input name="status" value="${modifybean.status}" class="required" type="text" size="80"/>
					    </td>
				    </tr>
...
$("#Apply_user").val("${modifybean.user.id}");
