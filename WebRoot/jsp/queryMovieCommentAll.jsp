...
<body>
<form name="queryForm" id="queryForm" method="post" action="${ctx}/sys/queryMovieCommentAll.do">
        ...
        <tr>
          <td height="62" background="${ctx}/images/nav04.gif">
		   <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		    <tr>
			  	<td width="538">
					关键字:<input name="s_content" type="text" size="12" class=""/>
...
function dodelete(ids){
	if(window.confirm("确定要删除选中的信息")){
		window.location.href="${ctx}/sys/deleteMovieCommentAll.do?ids="+ids;
	}
}
function toAdd(){
