        ...
        <tr>
          <td height="62" background="${ctx}/images/nav04.gif">
		   <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		    <tr>
			  <td width="21"><img src="${ctx}/images/ico07.gif" width="20" height="18" /></td>
			  	<td width="538">
					姓名:<input name="s_userName" type="text" size="12" class=""/>
              ...
              <tr>
				...
				<table style="margin-top: 10px" width="100%"  class="table table-striped table-hover table-bordered">
                  ...
                  <c:forEach items="${SESSION_PAGE.list}" var="item">
	                  <tr bgcolor="#FFFFFF">
					    <td height="20" align="center"><input type="checkbox" name="delid" value="${item.id }"/></td>
	                   		<td>${item.uname}</td>
							<td>${item.userName}</td>
      ...
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="33"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="right-font08">
              <tr>
                <td width="50%">共 <span class="right-text09">${SESSION_PAGE.totalPage}</span> 页 | 第 <span class="right-text09">${SESSION_PAGE.currentPageNumber}</span> 页</td>
                ...
                <td width="1%"><table width="20" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="1%"><input name="pageNum" type="text" class="right-textfield03" size="1" style="height:20px"/></td>
