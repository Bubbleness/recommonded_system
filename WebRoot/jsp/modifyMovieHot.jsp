				...
				<legend>${actionname }信息</legend>
				  <table style="width:95%"  class="table table-striped table-hover table-bordered">
				  	...
				  	<tr>
					    ...
					    <td width="84%">
					    	<img alt="" src="${ctx}/resource/${modifybean.imgFile}" style="border-radius:0.1em;" width="120px" onerror="javascript:this.src='${ctx}/resource/no.jpg'"><br/>
					    	<input type="hidden" value="${modifybean.imgFile}" name="imgFile"/>
					    	<input name="resfile" class="" value="" type="file"/>
					    </td>
				    </tr>
