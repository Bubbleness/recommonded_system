                  ...
                  <c:forEach items="${SESSION_PAGE.list}" var="item">
	                  <tr>
					    <td><input type="checkbox" name="delid" value="${item.id }"/></td>
	                   		<td>${item.movie.movieArea.name}</td>
	                   		<td>${item.movie.movieType}</td>
	                   		<td>${item.movie.name}</td>
	                   		<td>${item.movie.note}</td>
	                   		<td>${item.movie.movieYear}</td>
	                   		<td>${item.movie.score}</td>
	                   		<td>${item.movie.scoreUserNumber}</td>
	                   		<td>${item.movie.daoyan}</td>
	                   		<td>${item.movie.yanyuan}</td>
	                   		<td>${item.movie.shichang}</td>
	                   		<td>${item.movie.shangyingshijian}</td>
	                   		<td>${item.movie.yuyan}</td>
