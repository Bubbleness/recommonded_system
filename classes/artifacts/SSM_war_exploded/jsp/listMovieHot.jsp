        ...
        <tr>
          <td height="62" background="${ctx}/images/nav04.gif">
		   <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		    <tr>
			  	<td width="538">
					名称:<input name="s_name" type="text" size="12" class=""/>
                  ...
                  <c:forEach items="${SESSION_PAGE.list}" var="item">
	                  <tr>
					    <td><input type="checkbox" name="delid" value="${item.id }"/></td>
	                   		<td>
	                   		<img alt="" src="${ctx}/resource/${item.imgFile}" style="border-radius:0.1em;" width="60px" onerror="javascript:this.src='${ctx}/resource/no.jpg'"> 
	                   		</td>
	                   		<td>${item.name}</td>
	                   		<td>${item.murl}</td>
