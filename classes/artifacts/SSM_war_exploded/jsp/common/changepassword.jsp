...
<%--修改密码界面--%>
<form action="${ctx}/com/update${SESSION_BEAN.role}Password.do" method="post" enctype="multipart/form-data" name="fom" id="modifyForm">
<div class="MainDiv">
				...
				<legend>修改密码</legend>
				  <table style="width:95%"  class="table table-striped table-hover table-bordered">
				  	<tr>
					    ...
					    <td width="84%">
					    	 ${SESSION_BEAN.user.uname } 
				        </td>
				    </tr>
				  	<tr>
					    <td align="right" width="15%">姓名:</td>
					    <td width="84%"> ${SESSION_BEAN.user.userName } 
					    </td>
				    </tr>
				    <tr>
					    <td nowrap align="right" width="15%">密码:</td>
					    <td width="84%">
					    	<input name="oldpassword" id="password1" type="password" class="required"/>
				        </td>
				    </tr>
				  	<tr>
					    <td nowrap align="right" width="15%">新密码:</td>
					    <td width="84%">
